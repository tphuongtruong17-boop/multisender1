import { PrivateKey } from './branded.js';
 ...
 */
export declare function encodeWIF(privateKey: PrivateKey, compressed: boolean, network: Network): string;
/**
 ...
 */
export declare function decodeWIF(wifString: string, network: Network | readonly Network[]): WifDecodeResult;
