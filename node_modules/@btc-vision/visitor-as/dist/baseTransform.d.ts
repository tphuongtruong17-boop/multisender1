import { ArrayLiteralExpression, AssertionExpression, BinaryExpression, BlockStatement, BreakStatement, CallExpression, ClassDeclaration, ClassExpression, CommaExpression, CommentNode, ConstructorExpression, ContinueStatement, DecoratorNode, DoStatement, ElementAccessExpression, EmptyStatement, EnumDeclaration, EnumValueDeclaration, ExportDefaultStatement, ExportImportStatement, ExportMember, ExportStatement, Expression, ExpressionStatement, FalseExpression, FieldDeclaration, FloatLiteralExpression, ForStatement, FunctionDeclaration, FunctionExpression, FunctionTypeNode, IdentifierExpression, IfStatement, ImportDeclaration, ImportStatement, IndexSignatureNode, InstanceOfExpression, IntegerLiteralExpression, InterfaceDeclaration, LiteralExpression, MethodDeclaration, NamedTypeNode, NamespaceDeclaration, NewExpression, Node, NullExpression, ObjectLiteralExpression, ParameterNode, ParenthesizedExpression, PropertyAccessExpression, RegexpLiteralExpression, ReturnStatement, Source, Statement, StringLiteralExpression, SuperExpression, SwitchCase, SwitchStatement, TemplateLiteralExpression, TernaryExpression, ThisExpression, ThrowStatement, TrueExpression, TryStatement, TypeDeclaration, TypeName, TypeNode, TypeParameterNode, UnaryExpression, UnaryPostfixExpression, UnaryPrefixExpression, VariableDeclaration, VariableStatement, VoidStatement, WhileStatement } from "@btc-vision/assemblyscript/dist/assemblyscript.js";
