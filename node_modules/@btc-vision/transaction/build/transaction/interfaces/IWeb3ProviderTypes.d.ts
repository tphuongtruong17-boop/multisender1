import type { IDeploymentParameters, IFundingTransactionParameters, IInteractionParameters } from './ITransactionParameters.js';
...
export type IFundingTransactionParametersWithoutSigner = Omit<IFundingTransactionParameters, 'signer' | 'network' | 'mldsaSigner' | 'gasSatFee'>;
