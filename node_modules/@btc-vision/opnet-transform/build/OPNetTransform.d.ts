...
import { ClassDeclaration, Parser, Program, Statement } from '@btc-vision/assemblyscript/dist/assemblyscript.js';
...
export declare function isAssemblyScriptStdLib(internalPath: string): boolean;
